...
/// [`set_det_peak`]: crate::CadParams::set_det_peak
/// [`set_det_min`]: crate::CadParams::set_det_min
...
impl CadParams {
    ...
    ///
    /// ```
    /// use stm32wl_hal_subghz::CadParams;
    ///
    ...
    pub const fn new() -> CadParams {
        CadParams {
            buf: [crate::OpCode::SetCadParams as u8, 0, 0, 0, 0, 0, 0, 0],
        }
    ...
    ///
    /// ```
    /// use stm32wl_hal_subghz::{CadParams, NbCadSymbol};
    ///
    ...
    ///
    /// ```
    /// use stm32wl_hal_subghz::{CadParams, ExitMode};
    ///
    ...
    ///
    /// ```
    /// use stm32wl_hal_subghz::{CadParams, ExitMode, Timeout};
    ///
